...
//   "function" == typeof define && define.amd ?
//   define(["jquery"], t) :
//   t("object" == typeof exports ? require("jquery") : document.querySelector);
// })(function (t) {
// function s(s) {
//   var e = !1;
//   return (
...
//               this.bind(),
//               (this.notify = {
//                   document.querySelectorele: this.document.querySelectorele,
//                   update: function (s, e) {
//                       var i = {};
//                       "string" == typeof s ? (i[s] = e) : (i = s);
//                       for (var n in i)
//                           switch (n) {
//                               case "type":
//                                   this.document.querySelectorele.removeClass("alert-" + t.settings.type),
//                                       this.document.querySelectorele
//                                       .find('[data-notify="progressbar"] > .progress-bar')
//                                       .removeClass("progress-bar-" + t.settings.type),
//                                       (t.settings.type = i[n]),
//                                       this.document.querySelectorele
...
//                                   break;
//                               case "icon":
//                                   var a = this.document.querySelectorele.find('[data-notify="icon"]');
//                                   "class" === t.settings.icon_type.toLowerCase() ?
//                                       a.removeClass(t.settings.content.icon).addClass(i[n]) :
//                                       (a.is("img") || a.find("img"), a.attr("src", i[n]));
//                                   break;
//                               case "progress":
//                                   var o = t.settings.delay - t.settings.delay * (i[n] / 100);
//                                   this.document.querySelectorele.data("notify-delay", o),
//                                       this.document.querySelectorele
//                                       .find('[data-notify="progressbar"] > div')
//                                       .attr("aria-valuenow", i[n])
//                                       .css("width", i[n] + "%");
//                                   break;
//                               case "url":
//                                   this.document.querySelectorele.find('[data-notify="url"]').attr("href", i[n]);
//                                   break;
//                               case "target":
//                                   this.document.querySelectorele.find('[data-notify="url"]').attr("target", i[n]);
//                                   break;
//                               default:
//                                   this.document.querySelectorele.find('[data-notify="' + n + '"]').html(i[n]);
//                           }
//                       var r =
//                           this.document.querySelectorele.outerHeight() +
//                           parseInt(t.settings.spacing) +
//                           parseInt(t.settings.offset.y);
//                       t.reposition(r);
//                   },
...
//       buildNotify: function () {
//           var s = this.settings.content;
//           (this.document.querySelectorele = t(
//               String.format(
//                   this.settings.template,
//                   this.settings.type,
//                   s.title,
...
//               )
//           )),
//           this.document.querySelectorele.attr(
//                   "data-notify-position",
//                   this.settings.placement.from + "-" + this.settings.placement.align
//               ),
//               this.settings.allow_dismiss ||
//               this.document.querySelectorele.find('[data-notify="dismiss"]').css("display", "none"),
//               ((this.settings.delay <= 0 && !this.settings.showProgressbar) ||
//                   !this.settings.showProgressbar) &&
//               this.document.querySelectorele.find('[data-notify="progressbar"]').remove();
//       },
//       setIcon: function () {
//           "class" === this.settings.icon_type.toLowerCase() ?
//               this.document.querySelectorele
//               .find('[data-notify="icon"]')
//               .addClass(this.settings.content.icon) :
//               this.document.querySelectorele.find('[data-notify="icon"]').is("img") ?
//               this.document.querySelectorele
//               .find('[data-notify="icon"]')
//               .attr("src", this.settings.content.icon) :
//               this.document.querySelectorele
...
//                   (i.left = 0), (i.right = 0);
//           }
//           this.document.querySelectorele.css(i).addClass(this.settings.animate.enter),
//               t.each(Array("webkit-", "moz-", "o-", "ms-", ""), function (t, e) {
//                   s.document.querySelectorele[0].style[e + "AnimationIterationCount"] = 1;
//               }),
//               t(this.settings.element).append(this.document.querySelectorele),
//               this.settings.newest_on_top === !0 &&
//               ((e =
//                       parseInt(e) +
//                       parseInt(this.settings.spacing) +
//                       this.document.querySelectorele.outerHeight()),
//                   this.reposition(e)),
//               t.isFunction(s.settings.onShow) && s.settings.onShow.call(this.document.querySelectorele),
//               this.document.querySelectorele
//               .one(this.animations.start, function () {
//                   n = !0;
//               })
//               .one(this.animations.end, function () {
//                   s.document.querySelectorele.removeClass(s.settings.animate.enter),
//                       t.isFunction(s.settings.onShown) &&
//                       s.settings.onShown.call(this);
//               }),
//               setTimeout(function () {
...
//           var s = this;
//           if (
//               (this.document.querySelectorele.find('[data-notify="dismiss"]').on("click", function () {
//                       s.close();
//                   }),
//                   this.document.querySelectorele
//                   .mouseover(function () {
...
//                       t(this).data("data-hover", "false");
//                   }),
//                   this.document.querySelectorele.data("data-hover", "false"),
//                   this.settings.delay > 0)
//           ) {
//               s.document.querySelectorele.data("notify-delay", s.settings.delay);
//               var e = setInterval(function () {
//                   var t = parseInt(s.document.querySelectorele.data("notify-delay")) - s.settings.timer;
//                   if (
//                       ("false" === s.document.querySelectorele.data("data-hover") &&
//                           "pause" === s.settings.mouse_over) ||
//                       "pause" != s.settings.mouse_over
//                   ) {
//                       var i = ((s.settings.delay - t) / s.settings.delay) * 100;
//                       s.document.querySelectorele.data("notify-delay", t),
//                           s.document.querySelectorele
//                           .find('[data-notify="progressbar"] > div')
//                           .attr("aria-valuenow", i)
//                           .css("width", i + "%");
//                   }
...
//       close: function () {
//           var s = this,
//               e = parseInt(this.document.querySelectorele.css(this.settings.placement.from)),
//               i = !1;
//           this.document.querySelectorele
//               .attr("data-closing", "true")
//               .addClass(this.settings.animate.exit),
//               s.reposition(e),
//               t.isFunction(s.settings.onClose) &&
//               s.settings.onClose.call(this.document.querySelectorele),
//               this.document.querySelectorele
//               .one(this.animations.start, function () {
//                   i = !0;
//               })
...
//               setTimeout(function () {
//                   i ||
//                       (s.document.querySelectorele.remove(),
//                           s.settings.onClosed && s.settings.onClosed(s.document.querySelectorele));
//               }, 600);
//       },
//       reposition: function (s) {
//           var e = this,
...
//               this.settings.placement.align +
//               '"]:not([data-closing="true"])',
//               n = this.document.querySelectorele.nextAll(i);
//           this.settings.newest_on_top === !0 && (n = this.document.querySelectorele.prevAll(i)),
//               n.each(function () {
//                   t(this).css(e.settings.placement.from, s),
//                       (s =
//                           parseInt(s) +
