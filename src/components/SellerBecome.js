            ...
            <div className="col-lg-4 order-lg-2">
              <div className="poster-box">
                <div className="poster-image">
                  <img
                    src="../assets/images/vendor-page/become-saller.svg"
                    className="img-fluid"
                    alt=""
                  />
                </div>
        ...
        <div className="container-fluid-lg">
          ...
          <form>
            <div className="row">
              ...
              <div className="col-12">
                <button className="btn btn-md mt-3 theme-bg-color text-white">
                  Start Selling
                </button>
              </div>
            </div>
