                ...
                <div className="container-fluid-lg">
                    <div className="row">
                        <div className="col-12">
                            ...
                            >
                                {/* <img
                                    src="assets/images/landing-image/icon/1.png"
                                    className="image-1"
                                    alt=""
                                />
                                <img
                                    src="assets/images/landing-image/icon/2.png"
                                    className="image-2"
                                    alt=""
                                />
                                <img
                                    src="assets/images/landing-image/icon/3.png"
                                    className="image-3"
                                    alt=""
                                />
                                <img
                                    src="assets/images/landing-image/icon/4.png"
                                    className="image-4"
                                    alt=""
                                />
                                <img
                                    src="assets/images/landing-image/icon/5.png"
                                    className="image-5"
                                    alt=""
                                />
                                <img
                                    src="assets/images/landing-image/icon/6.png"
                                    className="image-6"
                                    alt=""
                                />
                                <img
                                    src="assets/images/landing-image/icon/7.png"
                                    className="image-7"
                                    alt=""
                                />
                                <img
                                    src="assets/images/landing-image/icon/8.png"
                                    className="image-8"
                                    alt=""
                                />
                                <img
                                    src="assets/images/landing-image/icon/9.png"
                                    className="image-9"
                                    alt=""
                                /> */}
                            </div>
                            <div className="home-contain" style={{display:'flex', textAlign:'center'}}>
                                <h1>
                                    MULTI-PURPOSE TECHGROPSE{" "}
                                    <span className="theme-color">
                                        {/* <img
                                            src="assets/images/landing-image/icon/border.png"
                                            alt=""
                                        />{" "} */}
                                        ECOMMERCE
                                    </span>{" "}
                ...
                <div className="container-fluid-lg">
                    <div className="row g-xl-5 g-4 justify-content-center">
                        ...
                        <div className="col-lg-4 col-sm-6 fixed-height">
                            ...
                            >
                                <div className="layout-image">
                                    <Link target="_blank" to="/index-food">
                                        <img
                                ...
                                <Link target="_blank" to="/index-food" className="layout-name">
